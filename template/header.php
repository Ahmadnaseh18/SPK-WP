...
<head>
    ...
    <style>
        ...
        #sidebar { 
            ...
            background: #0d6efd; color: #fff; transition: all 0.3s; 
        }
        
        #sidebar .sidebar-header { padding: 20px; background: #0b5ed7; }
        
        .sidebar-label { 
            padding: 15px 20px; font-size: 12px; text-transform: uppercase; 
            color: rgba(255, 255, 255, 0.6); font-weight: 700; 
        }

        #sidebar ul li a { 
            padding: 15px 20px; display: block; color: rgba(255, 255, 255, 0.8); 
            text-decoration: none; 
        }

        #sidebar ul li.active > a { 
            background: rgba(255, 255, 255, 0.2); color: #fff; 
            font-weight: 600; border-left: 4px solid #fff; 
        }
        ...
        .logout-btn { 
            ...
            margin: 10px 20px; border-radius: 5px; text-align: center; 
        }
        .main-footer {
        position: fixed;
        bottom: 0;
